...
```bash
gh issue list --repo TheTatu13/cramele-cotnari-sa-nodejs-scraper --state open
```
...
- `docs/test-results/index.html` — branding must say "CRAMELE COTNARI S.A.", not the old template

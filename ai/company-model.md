...
| Field        | Type     | Description |
|--------------|----------|-------------|
| brand        | string   | Commercial brand name (e.g. "Cotnari") |
| group        | string   | Parent company group (e.g. "Cramele Cotnari") |
...
- **scraperFile**: Full URL to the GitHub Actions workflow (no raw, e.g. `https://github.com/TheTatu13/cramele-cotnari-sa-nodejs-scraper/actions/workflows/job-seeker-ro-spider.yml`)
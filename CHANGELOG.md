...
### Added
- `tests/unit/api.test.js`: regression tests locking in CIF zero-padding on every API call site (getCompanyByCif, querySOLR, upsertCompany, deleteJobsByCIF, upsertJobs) — pulled in from Brewtality-3-16 template v1.1.0.

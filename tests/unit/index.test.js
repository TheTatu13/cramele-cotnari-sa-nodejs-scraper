...
describe('index.js Component Tests', () => {
  ...
  describe('transformJobsForSOLR', () => {
    ...
    it('should keep company uppercase', () => {
      const payload = {
        ...
        cif: '40321026',
        jobs: [
          { url: 'https://test.com/1', title: 'Job 1', company: 'cramele cotnari', cif: '40321026' }
        ]
      };
  ...
  describe('mapToJobModel', () => {
    it('should map raw job to job model format', () => {
      const rawJob = {
        url: 'https://www.bestjobs.eu/job/123',
      ...
      const COMPANY_NAME = 'CRAMELE COTNARI S.A.';
      const COMPANY_CIF = '40321026';
    ...
    it('should remove undefined fields', () => {
      ...
      const result = index.mapToJobModel(rawJob, '40321026');
